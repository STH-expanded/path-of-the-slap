class CharacterSelection extends Activity {
    ...
    selectCharacter = (pos, id) => this.characters[pos.x + pos.y * 3] ? new (this.characters)[pos.x + pos.y * 3](id) : null;

    selectStage = (game, cursor) => {
    ...
    updatePlayer = (game, cursor, readyNow) => {
