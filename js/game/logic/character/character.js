    ...
    constructor(playerId) {
        ...
        this.LOW_A = game => {
            ...
            if (this.frame > 4 && this.frame < 7) {
                this.hitboxes.push(new HitBox(new Vector2D(center.x + (this.direction ? 1 : -1) * 30, center.y - 16), new Vector2D(40, 24), 50, 10, false, 0));
        ...
        this.LOW_B = game => {
            ...
            if (this.frame > 20 && this.frame < 28) {
                this.hitboxes.push(new HitBox(new Vector2D(center.x + (this.direction ? 1 : -1) * 30, center.y + 18), new Vector2D(64, 24), 50, 15, true, 15));
        ...
        this.AERIAL_B = game => {
            ...
            if (this.frame > 3 && this.frame < 15) {
                this.hitboxes.push(new HitBox(new Vector2D(center.x + (this.direction ? 1 : -1) * 30, center.y + 16), new Vector2D(64, 24), 50, 15, false, 0));
        ...
        this.HIGH_A = game => {
            ...
            if (this.frame > 6 && this.frame < 9) {
                this.hitboxes.push(new HitBox(new Vector2D(center.x + (this.direction ? 1 : -1) * 32, center.y - 24), new Vector2D(40, 24), 50, 15, false, 0));
        ...
        this.HIGH_B = game => {
            ...
            if (this.frame > 11 && this.frame < 18) {
                this.hitboxes.push(new HitBox(new Vector2D(center.x + (this.direction ? 1 : -1) * 48, center.y - 16), new Vector2D(72, 32), 75, 30, false, 0));
