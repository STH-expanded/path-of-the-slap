...
// QCF INPUT
// if (((inputs.a && this.direction && !inputs.down && !inputs.left && inputList.length > 2 &&
//     inputList[inputList.length - 2].frameCount < 8 && this.GROUND_actions.includes(this.action) && !this.DASH_actions.includes(this.action) &&
//     ((inputList[inputList.length - 2].input.right && !inputList[inputList.length - 2].input.down && inputList[inputList.length - 3].input.down) ||
//     (inputs.right && inputList[inputList.length - 2].input.right && inputList[inputList.length - 3].input.down) ||
//     (inputs.right && !inputList[inputList.length - 2].input.right && inputList[inputList.length - 2].input.down))) || this.action === "QCF") &&
